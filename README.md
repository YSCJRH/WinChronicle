...
watcher preview, read-only MCP examples, known limitations, the `v0.1.9`
release-readiness record, the latest published `v0.1.8` release record, the
active post-v0.1.8 maintenance plan, and the completed post-v0.1.7 maintenance
plan.
...
- [v0.1.9 release-readiness record](docs/release-v0.1.9.md)

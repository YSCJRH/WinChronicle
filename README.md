...
watcher preview, read-only MCP examples, known limitations, the current
`v0.1.6` release-readiness record, the latest published `v0.1.5` release, and
the active post-v0.1.5 maintenance plan.
...
- [v0.1.6 maintenance release-readiness record](docs/release-v0.1.6.md)

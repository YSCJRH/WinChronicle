...
| Latest package/tag release | `v0.2.65` ([GitHub release](https://github.com/YSCJRH/WinChronicle/releases/tag/v0.2.65)) |
| Manual smoke relationship for latest package/tag | `v0.2.65` refreshes manual UIA smoke; the latest full manual UIA smoke source is [v0.2.65 release record](release-v0.2.65.md). |
...
| Historical next blueprint lane selection | [Next blueprint lane selection after v0.1.18](next-blueprint-lane-selection-post-v0.1.18.md) |
...
| Current full manual-smoke release record | [v0.2.65 release record](release-v0.2.65.md) |
...
| Previous release record | [v0.1.18 maintenance release record](release-v0.1.18.md) |
...
| Latest full manual-smoke release record | [v0.2.65 release record](release-v0.2.65.md) |
| Previous stable release record | [v0.1.19 maintenance release record](release-v0.1.19.md) |
| Latest full manual UIA smoke source | [v0.2.65 release record](release-v0.2.65.md) |
...
| Last freshness decision | For the published `v0.2.65` Workday watcher-launch safe-failure release, fresh hard-gate manual UIA smoke was rerun because product CLI/result error-output behavior changed after `v0.2.64`. Notepad and Edge passed, VS Code metadata passed with the known Monaco diagnostic warning, VS Code strict remains a diagnostic non-blocking failure, and fake-helper monitor watcher smoke passed. Artifact paths are local only. |
| Previous freshness decision | For the published `v0.2.64` Workday runner-launch safe-failure release, fresh hard-gate manual UIA smoke was rerun because product CLI error-output behavior changed after `v0.2.63`. |
...
| Notepad targeted UIA smoke | Hard manual release gate | Pass | Fresh for the published `v0.1.19` maintenance release | [v0.1.19 maintenance release record](release-v0.1.19.md) | Refresh if helper behavior, manual smoke scripts, capture behavior, privacy behavior, product CLI/MCP shape, capture surfaces, or release approval requirements change again | Local JSON artifact path only; do not commit capture JSON |
| Edge targeted UIA smoke | Hard manual release gate | Pass | Fresh for the published `v0.1.19` maintenance release | [v0.1.19 maintenance release record](release-v0.1.19.md) | Refresh if helper behavior, manual smoke scripts, capture behavior, privacy behavior, product CLI/MCP shape, capture surfaces, or release approval requirements change again | Local JSON artifact path only; do not commit local HTML or capture JSON |
| VS Code metadata smoke | Conditional hard manual release gate when `code.cmd` is available | Pass with diagnostic warning | Fresh for the published `v0.1.19` maintenance release | [v0.1.19 maintenance release record](release-v0.1.19.md) | Refresh if helper behavior, manual smoke scripts, capture behavior, privacy behavior, product CLI/MCP shape, capture surfaces, or release approval requirements change again | Local JSON artifact only; do not commit editor contents |
| VS Code strict Monaco marker | Diagnostic, non-blocking for v0.1 | Diagnostic failure, known Monaco/UIA limitation | Fresh diagnostic for the published `v0.1.19` maintenance release | [v0.1.19 maintenance release record](release-v0.1.19.md) | Refresh only if investigating Monaco/UIA exposure, changing smoke scripts, or release approval requires a new diagnostic | Local diagnostic artifact path only |
| Watcher preview live smoke | Preview diagnostic/manual confidence gate | Heartbeat-only liveness diagnostic; `captures_written: 0`, `heartbeats: 10`, `duplicates_skipped: 0`, `denylisted_skipped: 0` | Fresh diagnostic for the published `v0.1.19` maintenance release; deterministic watcher gates passed before publication | [v0.1.19 maintenance release record](release-v0.1.19.md) and `python harness/scripts/run_harness.py` | Refresh only if watcher preview behavior, live smoke scripts, deterministic watcher gates, or release approval requirements change | Do not save or commit raw watcher JSONL |
| Notepad targeted UIA smoke | Hard manual release gate | Pass | Fresh for the published `v0.2.0` monitor-session release | [v0.2.0 release record](release-v0.2.0.md) | Refresh if helper behavior, manual smoke scripts, capture behavior, privacy behavior, product CLI/MCP shape, capture surfaces, or release approval requirements change again | Local JSON artifact path only; do not commit capture JSON |
| Edge targeted UIA smoke | Hard manual release gate | Pass | Fresh for the published `v0.2.0` monitor-session release | [v0.2.0 release record](release-v0.2.0.md) | Refresh if helper behavior, manual smoke scripts, capture behavior, privacy behavior, product CLI/MCP shape, capture surfaces, or release approval requirements change again | Local JSON artifact path only; do not commit local HTML or capture JSON |
| VS Code metadata smoke | Conditional hard manual release gate when `code.cmd` is available | Pass with diagnostic warning | Fresh for the published `v0.2.0` monitor-session release | [v0.2.0 release record](release-v0.2.0.md) | Refresh if helper behavior, manual smoke scripts, capture behavior, privacy behavior, product CLI/MCP shape, capture surfaces, or release approval requirements change again | Local JSON artifact only; do not commit editor contents |
| VS Code strict Monaco marker | Diagnostic, non-blocking for v0.2 | Diagnostic failure, known Monaco/UIA limitation | Fresh diagnostic for the published `v0.2.0` monitor-session release | [v0.2.0 release record](release-v0.2.0.md) | Refresh only if investigating Monaco/UIA exposure, changing smoke scripts, or release approval requires a new diagnostic | Local diagnostic artifact path only |
| Fake-helper monitor watcher | Product monitor-session confidence gate | Pass; `captures_written: 1`, `heartbeats: 3`, local session/report paths only | Fresh for the published `v0.2.0` monitor-session release | [v0.2.0 release record](release-v0.2.0.md) and `python harness/scripts/run_harness.py` | Refresh if monitor-session behavior, watcher preview behavior, deterministic watcher gates, or release approval requirements change | Do not save or commit raw watcher JSONL |
| Notepad targeted UIA smoke | Hard manual release gate | Pass | Fresh for the published `v0.2.62` redaction hardening release | [v0.2.62 release record](release-v0.2.62.md) | Refresh if helper behavior, manual smoke scripts, capture behavior, privacy behavior, product CLI/MCP shape, capture surfaces, or release approval requirements change again | Local JSON artifact path only; do not commit capture JSON |
| Edge targeted UIA smoke | Hard manual release gate | Pass | Fresh for the published `v0.2.62` redaction hardening release | [v0.2.62 release record](release-v0.2.62.md) | Refresh if helper behavior, manual smoke scripts, capture behavior, privacy behavior, product CLI/MCP shape, capture surfaces, or release approval requirements change again | Local JSON artifact path only; do not commit local HTML or capture JSON |
| VS Code metadata smoke | Conditional hard manual release gate when `code.cmd` is available | Pass with diagnostic warning | Fresh for the published `v0.2.62` redaction hardening release | [v0.2.62 release record](release-v0.2.62.md) | Refresh if helper behavior, manual smoke scripts, capture behavior, privacy behavior, product CLI/MCP shape, capture surfaces, or release approval requirements change again | Local JSON artifact only; do not commit editor contents |
| VS Code strict Monaco marker | Diagnostic, non-blocking for v0.2 | Diagnostic failure, known Monaco/UIA limitation | Fresh diagnostic for the published `v0.2.62` redaction hardening release | [v0.2.62 release record](release-v0.2.62.md) | Refresh only if investigating Monaco/UIA exposure, changing smoke scripts, or release approval requires a new diagnostic | Local diagnostic artifact path only |
| Fake-helper monitor watcher | Product monitor-session confidence gate | Pass; `captures_written: 1`, `heartbeats: 4`, local session/report paths only | Fresh for the published `v0.2.62` redaction hardening release | [v0.2.62 release record](release-v0.2.62.md) and `python harness/scripts/run_harness.py` | Refresh if monitor-session behavior, watcher preview behavior, deterministic watcher gates, or release approval requirements change | Do not save or commit raw watcher JSONL |
| Notepad targeted UIA smoke | Hard manual release gate | Pass | Fresh for the published `v0.2.63` Workday safe-failure release | [v0.2.63 release record](release-v0.2.63.md) | Refresh if helper behavior, manual smoke scripts, capture behavior, privacy behavior, product CLI/MCP shape, capture surfaces, or release approval requirements change again | Local JSON artifact path only; do not commit capture JSON |
| Edge targeted UIA smoke | Hard manual release gate | Pass | Fresh for the published `v0.2.63` Workday safe-failure release | [v0.2.63 release record](release-v0.2.63.md) | Refresh if helper behavior, manual smoke scripts, capture behavior, privacy behavior, product CLI/MCP shape, capture surfaces, or release approval requirements change again | Local JSON artifact path only; do not commit local HTML or capture JSON |
| VS Code metadata smoke | Conditional hard manual release gate when `code.cmd` is available | Pass with diagnostic warning | Fresh for the published `v0.2.63` Workday safe-failure release | [v0.2.63 release record](release-v0.2.63.md) | Refresh if helper behavior, manual smoke scripts, capture behavior, privacy behavior, product CLI/MCP shape, capture surfaces, or release approval requirements change again | Local JSON artifact only; do not commit editor contents |
| VS Code strict Monaco marker | Diagnostic, non-blocking for v0.2 | Diagnostic failure, known Monaco/UIA limitation | Fresh diagnostic for the published `v0.2.63` Workday safe-failure release | [v0.2.63 release record](release-v0.2.63.md) | Refresh only if investigating Monaco/UIA exposure, changing smoke scripts, or release approval requires a new diagnostic | Local diagnostic artifact path only |
| Fake-helper monitor watcher | Product monitor-session confidence gate | Pass; `captures_written: 1`, `heartbeats: 4`, local session/report paths only | Fresh for the published `v0.2.63` Workday safe-failure release | [v0.2.63 release record](release-v0.2.63.md) and `python harness/scripts/run_harness.py` | Refresh if monitor-session behavior, watcher preview behavior, deterministic watcher gates, or release approval requirements change | Do not save or commit raw watcher JSONL |
| Notepad targeted UIA smoke | Hard manual release gate | Pass | Fresh for the published `v0.2.64` Workday runner-launch safe-failure release | [v0.2.64 release record](release-v0.2.64.md) | Refresh if helper behavior, manual smoke scripts, capture behavior, privacy behavior, product CLI/MCP shape, capture surfaces, or release approval requirements change again | Local JSON artifact path only; do not commit capture JSON |
| Edge targeted UIA smoke | Hard manual release gate | Pass | Fresh for the published `v0.2.64` Workday runner-launch safe-failure release | [v0.2.64 release record](release-v0.2.64.md) | Refresh if helper behavior, manual smoke scripts, capture behavior, privacy behavior, product CLI/MCP shape, capture surfaces, or release approval requirements change again | Local JSON artifact path only; do not commit local HTML or capture JSON |
| VS Code metadata smoke | Conditional hard manual release gate when `code.cmd` is available | Pass with diagnostic warning | Fresh for the published `v0.2.64` Workday runner-launch safe-failure release | [v0.2.64 release record](release-v0.2.64.md) | Refresh if helper behavior, manual smoke scripts, capture behavior, privacy behavior, product CLI/MCP shape, capture surfaces, or release approval requirements change again | Local JSON artifact only; do not commit editor contents |
| VS Code strict Monaco marker | Diagnostic, non-blocking for v0.2 | Diagnostic failure, known Monaco/UIA limitation | Fresh diagnostic for the published `v0.2.64` Workday runner-launch safe-failure release | [v0.2.64 release record](release-v0.2.64.md) | Refresh only if investigating Monaco/UIA exposure, changing smoke scripts, or release approval requires a new diagnostic | Local diagnostic artifact path only |
| Fake-helper monitor watcher | Product monitor-session confidence gate | Pass; `captures_written: 1`, `heartbeats: 3`, local session/report paths only | Fresh for the published `v0.2.64` Workday runner-launch safe-failure release | [v0.2.64 release record](release-v0.2.64.md) and `python harness/scripts/run_harness.py` | Refresh if monitor-session behavior, watcher preview behavior, deterministic watcher gates, or release approval requirements change | Do not save or commit raw watcher JSONL |
| Notepad targeted UIA smoke | Hard manual release gate | Pass | Fresh for the published `v0.2.65` Workday watcher-launch safe-failure release | [v0.2.65 release record](release-v0.2.65.md) | Refresh if helper behavior, manual smoke scripts, capture behavior, privacy behavior, product CLI/MCP shape, capture surfaces, or release approval requirements change again | Local JSON artifact path only; do not commit capture JSON |
| Edge targeted UIA smoke | Hard manual release gate | Pass | Fresh for the published `v0.2.65` Workday watcher-launch safe-failure release | [v0.2.65 release record](release-v0.2.65.md) | Refresh if helper behavior, manual smoke scripts, capture behavior, privacy behavior, product CLI/MCP shape, capture surfaces, or release approval requirements change again | Local JSON artifact path only; do not commit local HTML or capture JSON |
| VS Code metadata smoke | Conditional hard manual release gate when `code.cmd` is available | Pass with diagnostic warning | Fresh for the published `v0.2.65` Workday watcher-launch safe-failure release | [v0.2.65 release record](release-v0.2.65.md) | Refresh if helper behavior, manual smoke scripts, capture behavior, privacy behavior, product CLI/MCP shape, capture surfaces, or release approval requirements change again | Local JSON artifact only; do not commit editor contents |
| VS Code strict Monaco marker | Diagnostic, non-blocking for v0.2 | Diagnostic failure, known Monaco/UIA limitation | Fresh diagnostic for the published `v0.2.65` Workday watcher-launch safe-failure release | [v0.2.65 release record](release-v0.2.65.md) | Refresh only if investigating Monaco/UIA exposure, changing smoke scripts, or release approval requires a new diagnostic | Local diagnostic artifact path only |
| Fake-helper monitor watcher | Product monitor-session confidence gate | Pass; `captures_written: 1`, `heartbeats: 4`, local session/report paths only | Fresh for the published `v0.2.65` Workday watcher-launch safe-failure release | [v0.2.65 release record](release-v0.2.65.md) and `python harness/scripts/run_harness.py` | Refresh if monitor-session behavior, watcher preview behavior, deterministic watcher gates, or release approval requirements change | Do not save or commit raw watcher JSONL |
...
- The privacy-output release-readiness decision after `v0.1.18` starts a
  ...
  manual smoke freshness. The published `v0.1.19` maintenance release record
...
- The `v0.2.0` release record reran fresh hard-gate manual UIA smoke because
  product CLI/MCP shape and monitor-session output changed after `v0.1.19`.
  Notepad and Edge passed, VS Code metadata passed with the known Monaco
  diagnostic warning, VS Code strict remains diagnostic and non-blocking, and
  fake-helper monitor watcher smoke passed with local session/report paths.
- The published `v0.2.62` release record reran fresh hard-gate manual UIA smoke
  because privacy/redaction behavior changed after `v0.2.61`. Notepad and Edge
  passed, VS Code metadata passed with the known Monaco diagnostic warning, VS
  Code strict remains diagnostic and non-blocking, and fake-helper monitor
  watcher smoke passed with local session/report paths.
- The published `v0.2.63` release record reran fresh hard-gate manual UIA smoke
  because Workday product CLI error-output behavior changed after `v0.2.62`.
  Notepad and Edge passed, VS Code metadata passed with the known Monaco
  diagnostic warning, VS Code strict remains diagnostic and non-blocking, and
  fake-helper monitor watcher smoke passed with local session/report paths.
- The published `v0.2.64` release record reran fresh hard-gate manual UIA smoke
  because Workday product CLI error-output behavior changed after `v0.2.63`.
  Notepad and Edge passed, VS Code metadata passed with the known Monaco
  diagnostic warning, VS Code strict remains diagnostic and non-blocking, and
  fake-helper monitor watcher smoke passed with local session/report paths.
- The published `v0.2.65` release record reran fresh hard-gate manual UIA smoke
  because Workday product CLI/result error-output behavior changed after
  `v0.2.64`. Notepad and Edge passed, VS Code metadata passed with the known
  Monaco diagnostic warning, VS Code strict remains diagnostic and non-blocking,
  and fake-helper monitor watcher smoke passed with local session/report paths.
- The latest package/tag release is `v0.2.65`, and `v0.2.65` refreshes manual
  UIA smoke for its published Workday watcher-launch safe-failure release. The
  latest full manual UIA smoke source remains
  [v0.2.65 release record](release-v0.2.65.md) until a later release record

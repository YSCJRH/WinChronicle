...
| Latest package/tag release | `v0.2.48` ([GitHub release](https://github.com/YSCJRH/WinChronicle/releases/tag/v0.2.48)) |
| Manual smoke relationship for latest package/tag | `v0.2.48` does not refresh manual UIA smoke; it is separate from the latest full manual UIA smoke source unless a release record explicitly accepts or reruns manual smoke. |
...
- The latest package/tag release is `v0.2.48`, but `v0.2.48` does not refresh

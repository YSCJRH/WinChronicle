...
| Latest package/tag release | `v0.2.54` ([GitHub release](https://github.com/YSCJRH/WinChronicle/releases/tag/v0.2.54)) |
| Manual smoke relationship for latest package/tag | `v0.2.54` does not refresh manual UIA smoke; it is separate from the latest full manual UIA smoke source unless a release record explicitly accepts or reruns manual smoke. |
...
- The latest package/tag release is `v0.2.54`, but `v0.2.54` does not refresh

...
| Latest package/tag release | `v0.2.64` ([GitHub release](https://github.com/YSCJRH/WinChronicle/releases/tag/v0.2.64)) |
| Manual smoke relationship for latest package/tag | `v0.2.64` refreshes manual UIA smoke; the latest full manual UIA smoke source is [v0.2.64 release record](release-v0.2.64.md). |
...
| Current full manual-smoke release record | [v0.2.64 release record](release-v0.2.64.md) |
...
| Latest full manual-smoke release record | [v0.2.64 release record](release-v0.2.64.md) |
| Previous stable release record | [v0.1.19 maintenance release record](release-v0.1.19.md) |
| Latest full manual UIA smoke source | [v0.2.64 release record](release-v0.2.64.md) |
...
| Last freshness decision | For the published `v0.2.64` Workday runner-launch safe-failure release, fresh hard-gate manual UIA smoke was rerun because product CLI error-output behavior changed after `v0.2.63`. Notepad and Edge passed, VS Code metadata passed with the known Monaco diagnostic warning, VS Code strict remains a diagnostic non-blocking failure, and fake-helper monitor watcher smoke passed. Artifact paths are local only. |
| Previous freshness decision | For the published `v0.2.63` Workday safe-failure release, fresh hard-gate manual UIA smoke was rerun because product CLI error-output behavior changed after `v0.2.62`. |
...
- The published `v0.2.64` release record reran fresh hard-gate manual UIA smoke
  ...
  diagnostic warning, VS Code strict remains diagnostic and non-blocking, and
  fake-helper monitor watcher smoke passed with local session/report paths.
- The latest package/tag release is `v0.2.64`, and `v0.2.64` refreshes manual
  UIA smoke for its published Workday runner-launch safe-failure release. The

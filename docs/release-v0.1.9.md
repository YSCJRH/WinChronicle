...
| v0.1.8 publication reconciliation PR | https://github.com/YSCJRH/WinChronicle/pull/92 |
| v0.1.8 publication reconciliation Windows Harness | Passed, run `25562785206`, https://github.com/YSCJRH/WinChronicle/actions/runs/25562785206 |
| v0.1.8 publication reconciliation post-merge Windows Harness | Passed, run `25562905132`, https://github.com/YSCJRH/WinChronicle/actions/runs/25562905132 |
| W0 PR | https://github.com/YSCJRH/WinChronicle/pull/92 |
| W0 PR Windows Harness | Passed, run `25562785206`, https://github.com/YSCJRH/WinChronicle/actions/runs/25562785206 |
| W0 post-merge `main` Windows Harness | Passed, run `25562905132`, https://github.com/YSCJRH/WinChronicle/actions/runs/25562905132 |
| W1 PR | https://github.com/YSCJRH/WinChronicle/pull/93 |
| W1 PR Windows Harness | Passed, run `25563462333`, https://github.com/YSCJRH/WinChronicle/actions/runs/25563462333 |
| W1 post-merge `main` Windows Harness | Passed, run `25563589781`, https://github.com/YSCJRH/WinChronicle/actions/runs/25563589781 |
| W2 PR | https://github.com/YSCJRH/WinChronicle/pull/94 |
| W2 PR Windows Harness | Passed, run `25564182547`, https://github.com/YSCJRH/WinChronicle/actions/runs/25564182547 |
| W2 post-merge `main` Windows Harness | Passed, run `25564339025`, https://github.com/YSCJRH/WinChronicle/actions/runs/25564339025 |
| W3 PR | https://github.com/YSCJRH/WinChronicle/pull/95 |
| W3 PR Windows Harness | Passed, run `25564810377`, https://github.com/YSCJRH/WinChronicle/actions/runs/25564810377 |
| W3 post-merge `main` Windows Harness | Passed, run `25564926634`, https://github.com/YSCJRH/WinChronicle/actions/runs/25564926634 |
...
- Manual UIA smoke is not refreshed for this maintenance release candidate
  because W0-W4 changes are documentation, tests, CI/runtime metadata,
  deterministic harness evidence, compatibility evidence, and version metadata
  only. This W4 record explicitly accepts inherited `v0.1.0` Notepad, Edge, VS
  Code metadata, VS Code strict diagnostic, and watcher preview manual evidence
  for the compatible `v0.1.9` path only because helper behavior, watcher
...
| --- | --- | --- |
| `python -m pytest -q` | Pass | `113 passed in 14.22s` |
...
- Aligns package, runtime, and MCP server version identity to `0.1.9`.
- Records the `v0.1.9` maintenance release-readiness evidence from the
  post-v0.1.8 maintenance round.
- Keeps the v0.1 product boundary unchanged: no new capture surfaces, no new
  ...
  implementation.
- Records W0-W3 post-v0.1.8 maintenance evidence and accepts inherited manual
...
This maintenance release does not expand the capture surface from `v0.1.8`.
...
- Keep `v0.1.8` as the previous stable release.
- Do not retag or modify `v0.1.8`.

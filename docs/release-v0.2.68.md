...
| `python harness\scripts\check_release_evidence.py --project pyproject.toml --require-release-state docs\release-evidence.md` | Pass | current release evidence accepts published `v0.2.67` plus `v0.2.68` preflight |
...
Pending. After publication, update this record, `docs/release-evidence.md`,
`docs/release-checklist.md`, and `docs/manual-smoke-evidence-ledger.md` with
the final tag target SHA, GitHub release URL, publication timestamp, and Windows
Harness Actions run URL/head SHA.

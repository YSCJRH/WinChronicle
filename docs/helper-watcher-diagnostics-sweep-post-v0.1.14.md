...
This AC2 sweep reviews helper and watcher preview diagnostics after the
published `v0.1.14` baseline and AC1 public metadata audit. It records current
...
AC2 found no required helper or watcher product-code change. The reviewed docs,
...
No fresh manual UIA smoke is required for this AC2 sweep because it changes
...
The next smallest implementation task is AC3: re-check read-only MCP examples,

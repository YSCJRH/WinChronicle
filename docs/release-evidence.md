...
artifacts. The latest package/tag release is `v0.2.47`
([GitHub release](https://github.com/YSCJRH/WinChronicle/releases/tag/v0.2.47));
...
- the latest package/tag release is `v0.2.47`, recorded in the
  [v0.2.47 GitHub release](https://github.com/YSCJRH/WinChronicle/releases/tag/v0.2.47);
- the latest full manual UIA smoke source remains [v0.2.0 release record](release-v0.2.0.md);

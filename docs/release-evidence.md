...
artifacts. The latest package/tag release is `v0.2.58`
([GitHub release](https://github.com/YSCJRH/WinChronicle/releases/tag/v0.2.58));
...
| --- | --- |
| Release | `v0.2.58` |
| Release URL | https://github.com/YSCJRH/WinChronicle/releases/tag/v0.2.58 |
| Tag target SHA | `428f6bc6186cec6bc42327496a6a3c1f567a3126` |
...
| --- | --- |
| Release | `v0.2.59` |
| Expected release URL | https://github.com/YSCJRH/WinChronicle/releases/tag/v0.2.59 |
...
- the latest package/tag release is `v0.2.58`, recorded in the
  [v0.2.58 GitHub release](https://github.com/YSCJRH/WinChronicle/releases/tag/v0.2.58);
- the latest full manual UIA smoke source remains [v0.2.0 release record](release-v0.2.0.md);

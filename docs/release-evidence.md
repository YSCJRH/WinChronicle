...
artifacts. The latest package/tag release is `v0.2.59`
([GitHub release](https://github.com/YSCJRH/WinChronicle/releases/tag/v0.2.59));
...
| --- | --- |
| Release | `v0.2.59` |
| Release URL | https://github.com/YSCJRH/WinChronicle/releases/tag/v0.2.59 |
| Tag target SHA | `f1727357ae99e64ba5661bef8f7c8cf633395805` |
| Publication status | Published, not a draft, not a prerelease; published at `2026-06-19T21:50:55Z` |
| Windows Harness | Passed, https://github.com/YSCJRH/WinChronicle/actions/runs/27849877159, head `f1727357ae99e64ba5661bef8f7c8cf633395805` |
...
| --- | --- |
| Release | `v0.2.60` |
| Expected release URL | https://github.com/YSCJRH/WinChronicle/releases/tag/v0.2.60 |
...
| Post-publication reconciliation | Replace this preflight with Current Package Release Evidence for `v0.2.60`, including release URL, tag target SHA, publication status, Windows Harness URL, and Windows Harness head SHA. |
...
- the latest package/tag release is `v0.2.59`, recorded in the
  [v0.2.59 GitHub release](https://github.com/YSCJRH/WinChronicle/releases/tag/v0.2.59);
- the latest full manual UIA smoke source remains [v0.2.0 release record](release-v0.2.0.md);

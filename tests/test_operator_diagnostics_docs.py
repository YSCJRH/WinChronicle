...
def test_post_v018_plan_is_active_without_expanding_scope():
    ...
    for expected in (
        ...
        "W1 PR #93 passed PR Windows Harness run `25563462333`",
        "merged as `9c91f262ebb06f0b4fd8b4c38eeb17e8c688ecb9`",
        "post-merge `main` Windows Harness run `25563589781` passed",

...
def test_release_evidence_freshness_guard_labels_inherited_manual_smoke():
    ...
    for expected in (
        "## Evidence Freshness",
        "latest package/tag release is `v0.2.65`",
        "latest full manual UIA smoke source remains [v0.2.65 release record]",
        "`v0.2.65` does not refresh manual UIA smoke for the pending `v0.2.66`",
        "`v0.2.66` reruns manual UIA smoke",
    ...
    for expected in (
        ...
        "latest package/tag release is `v0.2.65`",
        "latest full manual UIA smoke source remains [v0.2.65 release record]",
        "`v0.2.66` refreshes manual UIA smoke",
        "`v0.2.65` records fresh deterministic preflight gates",
        "published\n  Workday watcher-launch safe-failure release",
        "`v0.2.64` records fresh deterministic preflight gates",
        "published\n  Workday runner-launch safe-failure release",
...
def test_manual_smoke_ledger_tracks_freshness_without_observed_artifacts():
    ...
    for expected in (
        ...
        "Latest package/tag release | `v0.2.65`",
        "Manual smoke relationship for latest package/tag | `v0.2.65` refreshes manual UIA smoke",
        ...
        "Current full manual-smoke release record | [v0.2.65 release record]",
        ...
        "Latest full manual-smoke release record | [v0.2.65 release record]",
        "Previous stable release record | [v0.1.19 maintenance release record]",
        "Latest full manual UIA smoke source | [v0.2.65 release record]",
        "Last freshness decision | For the published `v0.2.65` Workday watcher-launch safe-failure release",
        ...
        "Previous freshness decision | For the published `v0.2.64` Workday runner-launch safe-failure release",
        "fresh hard-gate manual UIA smoke was rerun because product CLI error-output behavior changed after `v0.2.63`",

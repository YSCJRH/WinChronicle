...
def test_release_evidence_freshness_guard_labels_inherited_manual_smoke():
    ...
    for expected in (
        "## Evidence Freshness",
        "latest package/tag release is `v0.2.67`",
        "latest full manual UIA smoke source remains [v0.2.67 release record]",
...
def test_manual_smoke_ledger_tracks_freshness_without_observed_artifacts():
    ...
    for expected in (
        ...
        "Latest package/tag release | `v0.2.67`",
        "Manual smoke relationship for latest package/tag | `v0.2.67` refreshes manual UIA smoke",
        ...
        "Current full manual-smoke release record | [v0.2.67 release record]",
        ...
        "Latest full manual-smoke release record | [v0.2.67 release record]",
        "Previous stable release record | [v0.1.19 maintenance release record]",
        "Latest full manual UIA smoke source | [v0.2.67 release record]",
        "Last freshness decision | For the published `v0.2.67` Workday stop path-boundary release",
        ...
        "Previous freshness decision | For the published `v0.2.66` Workday status privacy-boundary release",

...
def test_post_v018_plan_is_active_without_expanding_scope():
    ...
    for expected in (
        ...
        "W0 PR #92 passed PR Windows Harness run `25562785206`",
        "merged as `6d44aad77eedfb2480147ae8c112c3e001da4710`",
        "post-merge `main` Windows Harness run `25562905132` passed",

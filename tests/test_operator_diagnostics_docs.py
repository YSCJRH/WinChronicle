...
def test_release_evidence_freshness_guard_labels_inherited_manual_smoke():
    ...
    for expected in (
        "## Evidence Freshness",
        "latest package/tag release is `v0.2.66`",
        "latest full manual UIA smoke source remains [v0.2.66 release record]",
        "`v0.2.66` records fresh deterministic preflight gates",
        "published\n  Workday status privacy-boundary release",
...
def test_manual_smoke_ledger_tracks_freshness_without_observed_artifacts():
    ...
    for expected in (
        ...
        "Latest package/tag release | `v0.2.66`",
        "Manual smoke relationship for latest package/tag | `v0.2.66` refreshes manual UIA smoke",
        ...
        "Current full manual-smoke release record | [v0.2.66 release record]",
        ...
        "Latest full manual-smoke release record | [v0.2.66 release record]",
        "Previous stable release record | [v0.1.19 maintenance release record]",
        "Latest full manual UIA smoke source | [v0.2.66 release record]",
        "Last freshness decision | For the published `v0.2.66` Workday status privacy-boundary release",
        "fresh hard-gate manual UIA smoke was rerun because Workday status active-marker output and status JSON behavior changed after `v0.2.65`",
        ...
        "Previous freshness decision | For the published `v0.2.65` Workday watcher-launch safe-failure release",
        "fresh hard-gate manual UIA smoke was rerun because product CLI/result error-output behavior changed after `v0.2.64`",
        ...
        "Fresh for the published `v0.2.66` Workday status privacy-boundary release",
        ...
        "The published `v0.2.66` release record reran fresh hard-gate manual UIA",
        "Workday status active-marker output and status JSON behavior changed",
        "latest package/tag release is `v0.2.66`",

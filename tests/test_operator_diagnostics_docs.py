...
def test_release_evidence_freshness_guard_labels_inherited_manual_smoke():
    ...
    for expected in (
        "## Evidence Freshness",
        "latest package/tag release is `v0.2.48`",
...
def test_manual_smoke_ledger_tracks_freshness_without_observed_artifacts():
    ...
    for expected in (
        ...
        "Latest package/tag release | `v0.2.48`",
        "Manual smoke relationship for latest package/tag | `v0.2.48` does not refresh manual UIA smoke",

...
def test_operator_diagnostics_covers_stable_failure_modes_without_content_echo():
    ...
    for expected_signal in (
        ...
        "Helper exits nonzero | `ERROR: helper failed with exit code <code>`; high Windows status codes also include",
...
def test_release_evidence_freshness_guard_labels_inherited_manual_smoke():
    ...
    for expected in (
        "## Evidence Freshness",
        "latest package/tag release is `v0.2.68`",
        "latest full manual UIA smoke source remains [v0.2.68 release record]",
        "`v0.2.68` records fresh deterministic preflight gates",
        "published\n  Workday start privacy-boundary release",
        "`v0.2.67` records fresh deterministic preflight gates",
        "published\n  Workday stop path-boundary release",
        "`v0.2.65` records fresh deterministic preflight gates",
        "published\n  Workday watcher-launch safe-failure release",
        "`v0.2.64` records fresh deterministic preflight gates",
        ...
        "closed post-v0.1.18 execution record documents `v0.1.18` publication",
...
def test_manual_smoke_ledger_tracks_freshness_without_observed_artifacts():
    ...
    for expected in (
        ...
        "Latest package/tag release | `v0.2.68`",
        "Manual smoke relationship for latest package/tag | `v0.2.68` refreshes manual UIA smoke",
        ...
        "Historical next blueprint lane selection | [Next blueprint lane selection after v0.1.18]",
        ...
        "Current full manual-smoke release record | [v0.2.68 release record]",
        ...
        "Latest full manual-smoke release record | [v0.2.68 release record]",
        "Previous stable release record | [v0.1.19 maintenance release record]",
        "Latest full manual UIA smoke source | [v0.2.68 release record]",
        "Last freshness decision | For the published `v0.2.68` Workday start privacy-boundary release",
        "fresh hard-gate manual UIA smoke was rerun because Workday start active-marker output and runner cleanup behavior changed after `v0.2.67`",
        ...
        "Previous freshness decision | For the published `v0.2.67` Workday stop path-boundary release",
        "fresh hard-gate manual UIA smoke was rerun because Workday stop active-marker path handling changed after `v0.2.66`",
        ...
        "Fresh for the published `v0.2.64` Workday runner-launch safe-failure release",
        "Fresh for the published `v0.2.65` Workday watcher-launch safe-failure release",
        "Fresh for the published `v0.2.67` Workday stop path-boundary release",
        "Fresh for the published `v0.2.68` Workday start privacy-boundary release",
        ...
        "The published `v0.2.64` release record reran fresh hard-gate manual UIA",
        "Workday product CLI error-output behavior changed after `v0.2.63`",
        "The published `v0.2.65` release record reran fresh hard-gate manual UIA",
        "Workday product CLI/result error-output behavior changed after",
        "The published `v0.2.67` release record reran fresh hard-gate manual UIA",
        "Workday stop active-marker path handling changed",
        "The published `v0.2.68` release record reran fresh hard-gate manual UIA",
        "Workday start active-marker output and runner cleanup behavior changed",
        "latest package/tag release is `v0.2.68`",

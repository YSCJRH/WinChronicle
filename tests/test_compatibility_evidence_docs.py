...
def test_post_v0117_plan_is_active_without_expanding_scope():
    ...
    for phrase in (
        ...
        "Stage status: first committed negative fixture expansion complete",
        "Last completed evidence: Phase 6 committed negative contract fixture expansion PR #170 merged as `0ce32c7bf40a134fc18b5cf5647b36d617aac421`",
        "PR Windows Harness run `25606272408` passed",
        "post-fixture-expansion `main` Windows Harness run `25606329451`",
        "verified the post-fixture-expansion `main` Windows Harness concluded `success`",
        "no runtime, helper/watcher, CLI/MCP output, privacy-runtime",
        "Next atomic task: add committed negative Phase 6 contract fixtures",

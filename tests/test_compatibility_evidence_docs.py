...
def test_post_v0117_plan_is_active_without_expanding_scope():
    ...
    for phrase in (
        ...
        "Stage status: residual schema coverage audit complete",
        "Last completed evidence: Phase 6 gap fixture reconciliation PR #177 merged as `4d974be7135f26209f4836f4ff7fc850f722d720`",
        "PR Windows Harness run `25608596200` passed",
        "post-reconciliation `main` Windows Harness run `25608660366`",
        ...
        "future opt-in requirement booleans",

...
def test_post_v0117_plan_is_active_without_expanding_scope():
    ...
    for phrase in (
        ...
        "Stage status: residual policy fixture expansion complete",
        "Last completed evidence: Phase 6 residual policy fixture expansion PR #179 merged as `013ea612eb6cfe885130d0646ce816038fab2da4`",
        "PR Windows Harness run `25609287443` passed",
        "post-residual-policy-fixtures `main` Windows Harness run `25609341275`",
        "verified the post-residual-policy-fixtures `main` Windows Harness concluded `success`",
        "no runtime, helper/watcher, CLI/MCP output, privacy-runtime",
        "Next atomic task: decide whether to add lower-priority deferred fixtures",

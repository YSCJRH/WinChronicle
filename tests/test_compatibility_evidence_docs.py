...
def test_post_v0117_plan_is_active_without_expanding_scope():
    ...
    for phrase in (
        ...
        "Stage status: remaining negative fixture expansion in progress",
        "Last completed evidence: Phase 6 fixture expansion reconciliation PR #171 merged as `c9fc41632048db3083dc3ca552030268859d985e`",
        "PR Windows Harness run `25606538378` passed",
        "post-reconciliation `main` Windows Harness run `25606591806`",
        ...
        "Next atomic task: land the Phase 6 remaining negative contract fixture expansion",

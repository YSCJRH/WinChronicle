...
def test_post_v0117_plan_is_active_without_expanding_scope():
    ...
    for phrase in (
        ...
        "Stage status: contract preflight complete; the next Phase 6 step is a docs/tests/fixtures-only expansion",
        "Last completed evidence: Phase 6 privacy-enrichment contract preflight PR #168 merged as `ef2e9c11afce196ce1a574791b622320e8f20bb8`",
        "PR Windows Harness run `25605546803` passed",
        "post-preflight `main` Windows Harness run `25605600008`",
        ...
        "unsafe default-enabled screenshot/OCR",

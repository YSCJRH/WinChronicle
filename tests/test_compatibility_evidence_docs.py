...
def test_post_v0117_plan_is_active_without_expanding_scope():
    ...
    for phrase in (
        ...
        "Stage status: lower-priority deferred schema branches are promoted",
        "Last completed evidence: Phase 6 residual policy evidence reconciliation PR #180 merged as `06a830fd8f8a7bcd4d44ab58f8a7aeb03a8dad2b`",
        "PR Windows Harness run `25609491795` passed",
        "post-reconciliation `main` Windows Harness run `25609534616`",
        ...
        "Next atomic task: complete PR review and merge for the deferred fixture closure",

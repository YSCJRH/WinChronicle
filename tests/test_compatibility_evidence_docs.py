...
def test_post_v0117_plan_is_active_without_expanding_scope():
    ...
    for phrase in (
        ...
        "Stage status: AG5 complete; no post-v0.1.17 release-readiness or publication path is open.",
        "Last completed evidence: AG5 release-readiness decision PR #166 merged as `a55f1024f2f0a131044eb6e288de945ec1dbb5b2`",
        "PR Windows Harness run `25604616542` passed",
        "post-AG5 `main` Windows Harness run `25604682902`",
        "verified the post-AG5 `main` Windows Harness concluded `success`",
        ...
        "contracts, fixtures, tests, scorecards, and docs only",
        "do not implement screenshot capture or OCR",

...
def test_post_v0117_plan_is_active_without_expanding_scope():
    ...
    for phrase in (
        ...
        "Stage status: residual policy fixture expansion complete locally",
        "Last completed evidence: Phase 6 residual schema coverage audit PR #178 merged as `0d85e8ce41bb5779e8be23126c811be6489fc00f`",
        "PR Windows Harness run `25608946219` passed",
        "post-residual-audit `main` Windows Harness run `25609004391`",
        "verified the post-residual-audit `main` Windows Harness concluded `success`",
        "no runtime, helper/watcher, CLI/MCP output, privacy-runtime",
        "Next atomic task: land the residual policy fixture expansion",

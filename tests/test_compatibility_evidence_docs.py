...
def test_post_v0117_plan_is_active_without_expanding_scope():
    ...
    for phrase in (
        ...
        "Stage status: contract preflight in progress; AG6 post-AG5 cursor reconciliation landed through PR #167",
        "Last completed evidence: AG6 cursor reconciliation PR #167 merged as `0b05b88018679d1fdaee8cb5e6440768badbc21a`",
        "PR Windows Harness run `25605013376` passed",
        "post-AG6 `main` Windows Harness run `25605064828`",
        "verified the post-AG6 `main` Windows Harness concluded `success`",

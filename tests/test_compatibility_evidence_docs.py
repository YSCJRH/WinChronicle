...
def test_post_v0117_plan_is_active_without_expanding_scope():
    ...
    for phrase in (
        ...
        "Stage status: remaining negative fixture expansion complete",
        "Last completed evidence: Phase 6 remaining negative fixture expansion PR #172 merged as `a17da99e267edadced464c19fdc4c69719bd626e`",
        "PR Windows Harness run `25606933793` passed",
        "post-remaining-fixtures `main` Windows Harness run `25606999596`",
        "verified the post-remaining-fixtures `main` Windows Harness concluded `success`",
        "no runtime, helper/watcher, CLI/MCP output, privacy-runtime",
        "Next atomic task: audit Phase 6 contract coverage",
        "no schema rejection case remains only in memory",

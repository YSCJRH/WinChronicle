...
def test_post_v0117_plan_is_active_without_expanding_scope():
    ...
    for phrase in (
        ...
        "Stage status: fixture expansion in progress; the lane remains docs/tests/fixtures-only",
        "Last completed evidence: Phase 6 preflight reconciliation PR #169 merged as `297f2637a0d1a24a3359076f956322b0fda81575`",
        "PR Windows Harness run `25605887788` passed",
        "post-reconciliation `main` Windows Harness run `25605945162`",
        ...
        "Next atomic task: land the Phase 6 committed negative contract fixture expansion",

...
def test_post_v0118_plan_is_active_without_expanding_scope():
    ...
    for phrase in (
        ...
        "Stage status: `v0.1.19` is published and AH18 records the publication evidence baseline.",
        "captures the release URL, published timestamp, final tag target",
        ...
        "Next atomic task: start a post-v0.1.19 maintenance cursor",

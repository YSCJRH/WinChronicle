...
def test_release_evidence_guide_records_published_current_release_and_next_preflight():
    ...
    assert "| Release | `v0.2.56` |" in evidence
    assert "| Release URL | https://github.com/YSCJRH/WinChronicle/releases/tag/v0.2.56 |" in evidence
    assert "| Tag target SHA | `91c6045f0ea5dec1944f5a8df67ad8c155e89cd7` |" in evidence
    assert (
    ...
    assert "| Release | `v0.2.57` |" in evidence
    assert (

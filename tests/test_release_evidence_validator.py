...
def test_release_evidence_guide_records_published_current_release_with_next_preflight():
    ...
    assert "| Release | `v0.2.65` |" in evidence
    assert "| Release URL | https://github.com/YSCJRH/WinChronicle/releases/tag/v0.2.65 |" in evidence
    assert "| Tag target SHA | `de6e37ad386ba299f9ee82e6a8b4e0d0ff876884` |" in evidence
    assert (
